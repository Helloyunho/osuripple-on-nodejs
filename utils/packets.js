...
module.exports.userStatus = (id, force=false) => {
    ...
    return packet.buildPacket(packetid.server_userStats, [
        ...
        [(65535 >= userToken.pp > 0) ? userToken.pp : 0, datatypes.uInt16 ]
    ])
}
...
module.exports.removeSpectator = (id) => {
    return packet.buildPacket(packetid.server_spectatorLeft, [[is, datatypes.sInt32]])
}
...
module.exports.channelInfo = (channel) => {
    ...
    chan = share.channels.channels[channel]
